...
use CAPTCHAReader\src\Repository\Identify\IdentifyYKTColLevenshteinRepository;
use CAPTCHAReader\src\Repository\Identify\IdentifyYKTColRepository;
trait IdentifyTrait
{
    use CommonTrait;
    ...
    public function getRepository($label)
    {
        switch ($label) {
            ...
            case 'YKTColLevenshtein':
                return new IdentifyYKTColLevenshteinRepository();
            case 'YKTCol':
                return new IdentifyYKTColRepository();
        }
    }
