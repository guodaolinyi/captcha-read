...
use CAPTCHAReader\src\Repository\Cutting\CuttingYKTFixedRepository;
use CAPTCHAReader\src\Repository\Cutting\CuttingYKTMoveRepository;
...
trait CuttingTrait
{
    ...
    public function getRepository($label)
    {
        switch ($label) {
            ...
            case "YKTFixed":
                return new CuttingYKTFixedRepository();
            case "YKTMove":
                return new CuttingYKTMoveRepository();
        }
    }
